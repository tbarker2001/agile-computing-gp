...
router.route('/update/:id').post((req, res) => {
    Task.findById(req.params.id)
        .then(task => {
            ...
            task.assigned_users = req.body.assigned_users;
            task.date = Date.parse(req.body.date);
            task.deadline = req.body.deadline === null ? null : Date.parse(req.body.deadline);
            task.nlp_labels = req.body.nlp_labels;
            task.manual_deleted_labels = req.body.manual_deleted_labels;
            task.manual_added_labels = req.body.manual_added_labels;
